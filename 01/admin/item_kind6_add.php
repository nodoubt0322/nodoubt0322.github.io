...
?>
<div  class="right">
  <div class="right01"> 通路介紹-新增第2層分類</div>
  
<ul>
      
      <li>
<form name=form1 method=post action="item_kind6_add_ok.php">
...
<input type=button value="放棄新增" onclick="location.replace('item_kind6.php?cid=<?=$cid;?>')">
</td></tr>
</table>
<BR><BR>
