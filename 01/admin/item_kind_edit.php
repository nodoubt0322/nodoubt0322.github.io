...
<div  class="right">
  <div class="right01"> 產品-修改第1層分類</div>
...
?>		 
<form name=form1 method=post action="item_kind_edit_ok.php">
...
<input type=button value="放棄修改.." onclick="location.replace('item_kind.php')">
</td></tr>
</table>
			<script language=javascript>
			function check(){
