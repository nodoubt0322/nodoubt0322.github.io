...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >今天 : "+gMonths[gToday[1]-1]+" "+gToday[2]+"日, "+gToday[0]+"年</A>";	// the content of the bottom section.
...
var gcSat="green";	// Saturday font color
...
var gcBGToday="pink";	// the background color for today 
...
var giShowInterval=150;	// interval time in milliseconds that controls the auto-traverse speed.
