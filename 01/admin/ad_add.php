...
?>
<div  class="right">
  <div class="right01"> 新增左下方廣告(寬:191)</div>
  
<ul>
      
      <li>

<form name=form1 method=post action="ad_add_ok.php" enctype="multipart/form-data">
...
<input type=button value="放棄新增" onclick="location.replace('ad.php')">
</td></tr>
</table>
<BR><BR>
