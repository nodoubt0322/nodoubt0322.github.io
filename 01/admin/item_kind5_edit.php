...
<div  class="right">
  <div class="right01"> 通路介紹-修改第1層分類</div>
...
?>		 
<form name=form1 method=post action="item_kind5_edit_ok.php">
...
<input type=button value="放棄修改.." onclick="location.replace('item_kind5.php')">
</td></tr>
</table>
			<script language=javascript>
			function check(){
