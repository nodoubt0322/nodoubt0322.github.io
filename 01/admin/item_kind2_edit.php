...
?>
<div  class="right">
  <div class="right01"> 產品-修改第2層分類</div>
...
<table width="650" border="0" style="color:black;">
    <tr>
      <td align=center>
<form name=form1 method=post action="item_kind2_edit_ok.php">
...
<input type=button value="放棄修改.." onclick="location.replace('item_kind2.php?cid=<?=$cid;?>')">
</td></tr>
</table>
