<?php
session_start(); //Joe註:如需要多用戶圖庫，需啟動session 
/*
...
function CheckAuthentication()
{
	...
	//return false; Joe註:原設定為false，未開啟無法上傳檔案
	return true; 
}
...
*/	
	$baseUrl = '/nodoubt/01/uploadfiles/';
/*
ATTENTION: The trailing slash is required.
*/
//$baseUrl = '/102/upload/user/'. $_SESSION['dancer_admin_id'] . '/' ; //Joe註:路徑
//Joe註:絕對路徑，如加上. $_SESSION['sessionname'] . '/' 可創建多用戶路徑。
...
ATTENTION: The trailing slash is required.
*/
//$baseDir = 'C:/AppServ/www/102/upload/' ;
//Joe註:絕對路徑，如加上. $_SESSION['sessionname'] . '/' 可創建多用戶路徑。
$baseDir = resolveUrl($baseUrl);
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,zip',
		'deniedExtensions' => '');
