...
?>
<div  class="right">
  <div class="right01"> 產品-新增第1層分類</div>
  
<ul>
      
      <li>
<form name=form1 method=post action="item_kind_add_ok.php">
...
<input type=button value="放棄新增" onclick="location.replace('item_kind.php')">
</td></tr>
</table>
<BR><BR>
