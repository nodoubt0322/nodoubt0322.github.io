...
?>
<div  class="right">
  <div class="right01"> 通路介紹-新增第1層分類</div>
  
<ul>
      
      <li>
<form name=form1 method=post action="item_kind5_add_ok.php">
...
<input type=button value="放棄新增" onclick="location.replace('item_kind5.php')">
</td></tr>
</table>
<BR><BR>
